                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription className="flex items-center gap-2 mt-1 bg-[#2d5f3f] text-white px-3 py-1.5 rounded-md">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {order.items.map((item, index) => (
                        <div key={index} className="flex items-center gap-3 p-3 bg-[#2d5f3f] text-white rounded-lg">
                          {item.image && (
                            <img
                              src={item.image}
                              alt={item.name}
